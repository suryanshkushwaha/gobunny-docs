...
function CommandDialog({
  ...
  // Added for the docs site: the search does its own relevance ranking, so it
  // needs to pass shouldFilter={false} through to cmdk. Purely a passthrough —
  // no class names or markup change.
  commandProps,
  ...props
